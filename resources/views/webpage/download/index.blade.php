...
[
    "og_title" => "Baixar mp3 $song->title",
    "og_des" => "",
    "title" => "Baixar mp3 $song->title"
])
                ...
                <div class="">
                    <div class="box">
                        ...
                        <div class="post_container">
                            ...
                            <div class="post_head">
                                <h1 class="post_name">Baixar {{$song->title}}</h1>
                                <script>
                                    var jQInit = jQInit || [];
                ...
                <div class="download-section">
                    <div id="download-ringtone" class="overlay">
                        <div class="title-download">
                            <h2>Baixar {{$song->title}} </h2>
                        </div>


                        <div class="popup">
                            <p class="title-report">Baixar</p>
                            ...
                            <div class="popup-content" style="display: flex;">
                                ...
                                <div class="box-cross mb-20">
                                    <div class="bc-title">{{$song->title}} Baixar</div>
                                    <div class="bc-body wrap-box-mod">
                                        ...
                                        <div class="links">
                                            <div class="item item-obb">
                                                <span>MP3 File:</span>
                                                <a href="{{route("dlDownload"). "?id=" .$song->id}}" class="btn btn-green">Baixar mp3</a>
                                            </div>
                        ...
                        <div class="download-err">
                            <span>Se o download não começar em alguns segundos, </span> <a href="{{route("dlDownload"). "?id=" .$song->id}}">clique aqui!!!!</a>
                        </div>
                    </div>
                </div>
                <div class="box column-3">
                    <h3 class="title">{{$category->category_name}} também pode gostar</h3>
